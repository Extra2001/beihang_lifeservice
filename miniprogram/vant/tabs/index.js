...
VantComponent({
  ...
  methods: {
    ...
    onTouchScroll(event) {
      if (event.detail.isFixed && (!this.data.scrollClass))
        this.setData({ scrollClass: "van-tabs__scroll--active" });
      else if ((!event.detail.isFixed) && this.data.scrollClass)
        this.setData({ scrollClass: "" });
